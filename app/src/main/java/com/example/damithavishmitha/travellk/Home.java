...
import com.example.damithavishmitha.travellk.Model.Category;
import com.example.damithavishmitha.travellk.ViewHolder.MenuViewHolder;
            ...
            protected void populateViewHolder(MenuViewHolder viewHolder, Category model, int position) {
                ...
                viewHolder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        //Category id
                        Intent hotelList = new Intent(Home.this,HotelList.class);
                        //cat id is key
                       hotelList.putExtra("CategoryId",adapter.getRef(position).getKey());
